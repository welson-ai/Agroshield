...
interface BoardPropertyDetailModalProps {
...
export default function BoardPropertyDetailModal({
  property,
  gameProperty,
  players,
  isMyTurn,
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className={`h-20 ${PROPERTY_COLOR_CLASS[property.color || ""] ?? "bg-gray-600"}`} />
          <div className="p-6">
            <h2 className="text-2xl font-bold text-center mb-4">{property.name}</h2>
            <p className="text-center text-gray-300 mb-6">Price: ${property.price}</p>
